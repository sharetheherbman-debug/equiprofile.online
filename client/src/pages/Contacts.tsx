...
import { Plus, Phone, Mail, MapPin, Trash2, Edit, Building2 } from "lucide-react";
...
function ContactsContent() {
  ...
  const groupedContacts = localContacts.reduce((acc, contact) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="font-serif text-3xl font-bold text-foreground">Contacts</h1>
      ...
      {localContacts.length === 0 ? (
        <Card className="text-center py-16">
          <CardContent>
            ...
            <h3 className="font-serif text-xl font-semibold mb-2">No contacts yet</h3>
              ...
              <CardContent>
                <div className="space-y-3">
                  {typeContacts.map((contact) => (
                    <div key={contact.id} className="flex items-start gap-4 p-4 border rounded-lg hover:bg-muted/50 transition-colors">
