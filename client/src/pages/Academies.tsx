...
function ROICalculator() {
  // Default to 15 students — midpoint of the "Medium Academy" tier (0–20)
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">
            See what EquiProfile saves your Academy
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          ...
          <div className="bg-white/[0.04] rounded-xl p-4 text-center">
            ...
            <p className="text-xl font-bold text-[#7dd3c0]">
              {students * hoursSavedPerStudent}h/mo
            </p>
          </div>
          <div className="bg-white/[0.04] rounded-xl p-4 text-center">
        ...
        <p className="text-[11px] text-gray-600 mt-2">
          Based on estimated {hoursSavedPerStudent} hours/month admin time saved
          per student at £{costPerHour}/hr.
        </p>
      </div>
    </div>
  );
            ...
            <ScrollReveal>
              <div className="text-center max-w-3xl mx-auto mb-14">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#5b8def]/10 border border-[#5b8def]/20 mb-6">
                  ...
                  <span className="text-sm text-[#7baaf5] font-medium">
                    Purpose-Built for Schools
                  </span>
                </div>
                <h2 className="text-3xl md:text-4xl font-bold font-serif text-white mb-4">
                  Everything Your Academy Needs in{" "}
                  <span className="bg-gradient-to-r from-[#5b8def] to-[#7dd3c0] bg-clip-text text-transparent">
                    One Platform
                  </span>
                </h2>
                <p className="text-gray-400 text-lg">
                  Replace scattered worksheets, paper records, and ad-hoc
                  messaging with a single platform that manages learning,
                  progression, communication, and administration.
                </p>
              </div>
            </ScrollReveal>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-6xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  desc: "Invite teachers and students by email. Manage roles, seats, and access from your Academy dashboard.",
            ...
            <div className="container mx-auto px-4">
              <ScrollReveal>
                <div className="text-center max-w-2xl mx-auto mb-12">
                  ...
                  <p className="text-gray-400">
                    Whether you run a small riding school or a large equestrian
                    college, EquiProfile scales with you.
                  </p>
                </div>
              </ScrollReveal>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                {[
                  ...
                  >
                    <div
                      className={`h-2 bg-gradient-to-r ${useCase.gradient}`}
                    />
                    <div className="p-6">
                ...
                <div className="bg-[#111827] border border-white/[0.06] rounded-2xl p-6 md:p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        Simple seat-based plans. 7-day free trial.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 mb-6">
                    {[
                      ...
                      <div
                        key={plan.tier}
                        className="flex items-center justify-between py-3 px-4 rounded-lg bg-white/[0.03] border border-white/[0.04]"
                      >
                        <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <Link href="/contact">
                      <Button
                        variant="outline"
                        className="w-full border-white/10 text-white hover:bg-white/5 h-11 text-sm"
                      >
                        Book a Demo
                      </Button>
                    </Link>
            ...
            <div className="container mx-auto px-4">
              <ScrollReveal>
                <div className="text-center max-w-2xl mx-auto mb-12">
                  ...
                  <p className="text-gray-400">
                    Setting up your Academy on EquiProfile is simple and guided.
                  </p>
                </div>
              </ScrollReveal>
                ...
                {[
                  {
                    ...
                    desc: "Name your Academy and choose your plan tier",
                  },
                  {
                    step: "2",
                    title: "Invite Teachers",
                    desc: "Send email invites to your teaching team",
                  },
                  {
                    step: "3",
                    title: "Add Students",
                    desc: "Invite students who get their own learning dashboards",
                  },
                  {
                    step: "4",
                    title: "Start Teaching",
                    desc: "Assign lessons, track progress, and give feedback",
                  },
                ].map((step, idx) => (
                  <motion.div
                    key={idx}
          ...
          <section className="container mx-auto px-4 py-16 md:py-28">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-gray-400 mb-8">
                Join riding schools and equestrian centres already using
                EquiProfile to deliver structured, trackable learning.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link href="/register">
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-[#2e86ab] to-[#5b8def] hover:from-[#1a5276] hover:to-[#4a7dd4] text-white px-8 h-12 text-sm font-semibold gap-2"
                  >
                ...
                <Link href="/contact">
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-white/10 text-white hover:bg-white/5 px-8 h-12 text-sm"
                  >
                    Contact Sales
                  </Button>
                </Link>
