...
# the management and Academy builds were copied into the same directory.
#
...
#
#   Academy build outputs:
#     dist/public/academy/academy-assets/           → served at /academy-assets/
#
...
echo "   (management-assets/ and academy-assets/) replaces the merge approach."
